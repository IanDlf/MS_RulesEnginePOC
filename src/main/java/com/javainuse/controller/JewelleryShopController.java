...
public class JewelleryShopController {
	...
	public Product getQuestions(@RequestParam(required = true) String type, @RequestParam(required = false) String rolesVersion) {

		Product product = new Product();
		product.setType(type);

		jewelleryShopService.getProductDiscount(product, rolesVersion);
